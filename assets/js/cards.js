  ...
  function exibirDados(img, alt, title, nome, titulo, descricao) {
    ...
    "<div class='slick-card-item'> <div class='slick-card-body'> <div class='slick-card-image'> <img src='" + img + "' alt='" + alt + "' title='" + title + "'> </div> <div class='row'> <div class='col-sm-12 col-md-12 col-lg-12 slick-card-title'> <h3> " + nome + " </h3> <p> " + titulo + " </p> <hr> </div> <div class='col-sm-12 col-md-12 col-lg-12 slick-card-description'> <p> " + descricao + " </p> </div> <div class='col-sm-12 col-md-12 col-lg-12 slick-card-social'> <span class='fab fa-twitter'></span> <span class='fab fa-linkedin-in'></span> <span class='fab fa-facebook'></span> </div> </div> </div> </div>";
  }
